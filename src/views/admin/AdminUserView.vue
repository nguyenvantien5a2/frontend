            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center">
                <div class="flex-shrink-0 h-10 w-10">
                  <img v-if="user.avatarUrl" :src="getImageUrl(user.avatarUrl)" class="h-10 w-10 rounded-full object-cover" alt="Avatar" referrerpolicy="no-referrer">
        ...
        <div v-if="selectedUser" class="space-y-8">
          ...
          <div class="flex items-start gap-6">
            <div class="h-24 w-24 flex-shrink-0">
              <img v-if="selectedUser.avatarUrl" :src="getImageUrl(selectedUser.avatarUrl)" class="h-24 w-24 rounded-full object-cover border border-gray-200" alt="Avatar" referrerpolicy="no-referrer">
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="order in userOrders" :key="order.id" class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 text-sm text-gray-600">{{ new Date(order.createdAt).toLocaleString('vi-VN') }}</td>
                    <td class="px-4 py-3 text-sm font-bold text-red-600">{{ order.totalPrice.toLocaleString('vi-VN') }} ₫</td>
