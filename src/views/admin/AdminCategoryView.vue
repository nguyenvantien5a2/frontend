          ...
          <tr v-for="category in paginatedCategories" :key="category.id" class="hover:bg-gray-50 transition-colors group">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center">
                <div class="flex-shrink-0 h-10 w-10 rounded-lg bg-blue-50 flex items-center justify-center text-blue-600 mr-4 group-hover:bg-blue-100 transition">
...
const fetchCategories = async () => {
  loading.value = true
  try {
    const res = await api.get('/admin/categories') // Hoặc /categories nếu dùng chung API public
...
<!--
[PROMPT_SUGGESTION]Làm sao để hiển thị số lượng sản phẩm có trong mỗi danh mục ngay tại bảng này?[/PROMPT_SUGGESTION]
[PROMPT_SUGGESTION]Tôi muốn thêm tính năng sắp xếp danh mục theo tên A-Z hoặc Z-A.[/PROMPT_SUGGESTION]
-->